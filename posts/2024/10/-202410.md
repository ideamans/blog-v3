...
# Astrowind
title: '月報 2024年10月'
excerpt: '弊社はプログラミングを武器とする会社なので、ロゴマークもプログラムで描こうというポリシーがあります。今月、そのロゴマークのアルゴリズムを初めて改訂しまして、よりバラエティ豊かな原石のようなロゴマークになりました。'
...
10月は突然、LLMワークフロービルダーの[Dify](https://dify.ai/jp)へ夢中になり、勢いでいろいろと記事を書きました。
...
このテーマは今になっても、検証してみないと真実がわからない部分もあります。
