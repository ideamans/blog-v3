...
この困難の救世主となったこともスゴいですが、耐えているシステムもスゴい！

さて、ZOOMは背景を差し替えるバーチャル動画機能もよくできています。

あのDr. Capitalのインパクト抜群の背景を、誰でもZOOMのバーチャル背景にできたら面白いなと思って開発したのが、ドクターキャピタル Dr. Capital風背景メーカーです。

[ドクター・キャピタル Dr. Capital風背景メーカー](https://www.ideamans.com/dr.capital/)



## 使い方

使い方は簡単です。1. 自分の好きな色に変更して、2. メールアドレスを入力、3. 「動画ファイルを作成してダウンロード」ボタンを押すだけです。

<a href="https://blog.ideamans.com/assets/0a02f1dfeb2ecc495d6315d453389ed27e5065fe.png"><img alt="dr-capital-usage.png" src="https://blog.ideamans.com/assets_c/2020/05/0a02f1dfeb2ecc495d6315d453389ed27e5065fe-thumb-autox1055-1149.png" width="900" height="1055" class="mt-image-center" style="text-align: center; display: block; margin: 0 auto 20px;" /></a>

少し待つと、ダウンロード用のURLにメールが送信されます。

メールで送られたURLをクリックすると、ひとまずブラウザに動画ファイルが表示されるので、「名前をつけて保存」などでPCに保存してください。

ZOOMのバーチャル背景は、設定メニューから変更できます。

<img alt="zoom-virtual-usage.png" src="https://blog.ideamans.com/assets/zoom-virtual-usage.png" width="2168" height="1590" class="mt-image-center" style="text-align: center; display: block; margin: 0 auto 20px;" />

Dr. Capitalファンの方はぜひ今すぐ、そうでない方は氏の動画を楽しんでからぜひ遊んでみてください！
