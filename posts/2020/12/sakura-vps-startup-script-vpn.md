...
excerpt: '在宅ワークをはじめ、出社しない働き方が当たり前になりましたが、固定IPアドレスが必要な作業だけは出社しているという方もいたりするのではないでしょうか。IPv6プラスの普及により、自宅で固定IPを持つことが時代に逆行する流れとなりました。'
...
IPv6プラスの普及により、自宅で固定IPを持つことが時代に逆行する流れとなりました。外出先でも決まった固定IPとして接続できれば安心できる場面も多いはず。
...
[高速VPNを3分以内にスタート、ConoHaで月額630円 \- Qiita](https://qiita.com/miyanaga/items/590b25596d8a716e7e68)
