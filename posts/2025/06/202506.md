---
title: 月報 2025年6月
excerpt: サイトスピードと収益の新知見、Claude Codeによる開発スタイルの変革、そして1ヶ月で25以上のオープンソースプロジェクトを公開した2025年6月の活動報告。
authorId: miyanaga
publishedAt: 2025-06-30 20:00:00
categories: ['journal']
recommended: false
image: /images/2025/202506/ogp.jpg
---
...
これまで「必要な部品は一点ずつ丁寧に作る」が当たり前で、そのための技能やメソッドを学ぶ日々でした。しかしこれからは、AIの知識とスピードに人間の側が合わせる必要に迫られます。
...
そのような根拠で、アイデアを次々とオープンソースとして世界へ共有することにしました。
