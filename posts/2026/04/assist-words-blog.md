...
excerpt: '通販サイトで見かける気の利いたひと言「添え言葉」を集めるブログを始めました。なぜ「マイクロコピー」ではなくこの呼び方にしたのか、実例とあわせて紹介します。'
authorId: miyanaga
...
[北の快適工房](https://www.kaitekikobo.jp/)の注文フォームでは、すべての入力が終わった末尾に「入力お疲れ様でした！」と表示されます。機能や情報ではない、ただの労いの一言。しかしこの一言があるだけで、フォーム入力の疲れがふっと和らぎます。
