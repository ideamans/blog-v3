...
excerpt: 'Webの速度が大事と言われますが、どれくらい速くすればどのくらい収益が上がるのか、事前に予測できたらいいなと思いませんか？耳にするのは「速くしたらこうなった」結果論ばかりです。'
...
データの集計期間は記事執筆時の直近1週間(2022年4月12日〜18日)です。Webサイトの目的はさまざまでしょう。この記事では『直帰の少なさと一人当たりPVの多さ』を、収益との因果関係ありとみなします。
...
Webサイトは意図的に準備したわけではないが、**速度についてのA/Bテストを常に実施しているようなもの。だから自然実験ができるはず**というわけです。
...
回遊組(紫)の分布は、直帰組(黄色)の分布に比べて早い時間に偏っており、遅い時間の割合の少なさが見てとれます。
...
簡易的なため誤差もあり、これが完全に正確だとは限りません(そもそも100%の予測など不可能ですが...)。とはいえ、傾向自体が変わって極端に変動するとは考えにくいです。
