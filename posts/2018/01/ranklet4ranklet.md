...
excerpt: 'Ranklet のランキングに出るサムネイルは、既定でそのページのOGP画像を使います。OGP画像は大きいため、表示サイズに合った画像を指定して読み込みを軽くする方法を説明します。'
...
<h2>※シックス・アパートさんのBlogではMovable Typeで管理されているサイトでの改善方法を記事にしてもらっています。</h2>
