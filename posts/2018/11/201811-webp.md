---
# Astrowind
title: '2018年11月現在のWebPのブラウザ対応状況。Firefoxは65で対応予定'
excerpt: '2018年11月時点での WebP のブラウザ対応状況をまとめました。Firefox が65で対応予定となり、残る課題は Safari です。Mac版・iOS版とも対応の予定は出ていません。'
...
<h2><span>Chromeのシェアは依然として40%前後</span></h2>
