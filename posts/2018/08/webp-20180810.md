---
# Astrowind
title: '2018年8月現在のWebPのブラウザ対応状況を確認する'
excerpt: '2018年8月時点での WebP のブラウザ対応状況をまとめました。Chrome など Google 系は対応済みですが、Microsoft と Apple のブラウザは未対応のままです。'
...
<h2><span>Chromeのシェアは40%前後</span></h2>
