...
excerpt: '小ネタです。先日、VPNを用意する機会があったので、手順をブラッシュアップしてQiitaに共有しました。高速VPNを最速3分でスタート ConoHaで月額630円 リモートワークでときどき固定IPで作業しなければならない場合や、社外のパートナーに固定IPを用意しなければならない場合にあると便利です。'
