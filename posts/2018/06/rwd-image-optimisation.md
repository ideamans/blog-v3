...
excerpt: 'スマートフォンでウェブサイトをみることが、本当に多くなってきました。ウェブサイトの作りは十人十色であり、全く同じサイトは存在しないと行ってよいでしょう。今回は、レスポンシブ・ウェブ・デザイン（RWD）と画像最適化の関係について説明します。'
...
<ul><li>参考：<a href="https://sounansa.net/archives/2428" target="_blank">2017年最新版　iPhone・Androidスマホ　機種別画面サイズ、解像度、縦横比のまとめ</a></li></ul>
