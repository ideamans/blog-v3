...
残り28項目はいわば**ただのアドバイス**です。点数に直接関係する5項目へ影響する内容が多いです。改善するとスコアが上がるケースは多いのですが、上がらないこともあります(脚注※1)。
...
[画像の多いページもPageSpeed Insightsの点数が低い傾向](https://qiita.com/miyanaga/items/b3d955a6fd70ef7d89ec)も知られています。おそらく通信経路の渋滞で、必要なリソースの到着が遅れるからではないかと推測します(未検証につきあくまで憶測です)。
