---
# Astrowind
title: '通販サイト上位300のスマホトップは平均4.15MB、画質を落とさず41%削減できる'
excerpt: '通販上位300サイトのスマホトップページを調べたところ、画像だけで平均4.15MBありました。画質を落とさず41%削減できるという試算と、個別レポートを公開します。'
...
Webページを構成するデータのうち、最もデータ量の多いのが画像データです。
