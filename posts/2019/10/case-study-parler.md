...
excerpt: '弊社で画像軽量化のお手伝いをさせて頂いた人気エステサロンの「ラ・パルレ」様の事例をご紹介します。→ ラ・パルレ様のサイトはこちら 株式会社 ニューアート・ラ・パルレ 佐藤伸哉さま(マーケティング部マネージャー) サイトの画像軽量化はいつか必要だと、頭の片隅にありました。'
...
サイトの画像軽量化はいつか必要だと、頭の片隅にありました。

しかし、**手動で軽量化対応するのはかなりの手間**で、**軽量化することで見栄えが悪くなる**印象もありました。日々のタスクに追われていたのと、具体的な成果が見えなかったので優先順位は低めでした。
...
パソコンでじっくり見続けて、軽量化の影響がわかる範囲なので、スマートフォンだと見た目は変わりません。
