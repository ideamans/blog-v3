...
excerpt: '新サービス「PageSpeed改善リハーサル」を始めました。約20種類の高速化手法をお客様のページに適用したら何点上がるかを、実際に試してレポートします。'
...
中にはボトルネックを探るための非実用的なプラクティスも含まれるので実際にはもうちょっと少ないのですが、これを実際のWebサイトで検証しようとすると、サイトの規模によってはそれだけで数ヶ月かかるかもしれません。
