...
画像データを半分まで軽くするWebP。普及に向けた最後の最大の砦がiPhoneです。
...
Webサイトの提供者にすると「WebPはまだ考える必要なし」と思わせるシェアです。
...
新機能を追加するとその分ページの動作が重くなる(パフォーマンスは悪化する)リスクを、WebP対応で確実にヘッジするということです。
...
YESの場合、それは事実でしょうか、それとも推論でしょうか。YES・NOいずれにせよ、事実がわかれば未来の悩みを排除できることだけは真実です。

そのためにはやはり同時期のA/Bテストが正確です。特に通販サイトは時期・商品・企画により指標が変動しやすいので、軽量化の前後ではなく、A/Bテストがより望ましいと言えます。

次の実にわかりやすい対立軸が、いまあります。
...
以上の3点が、シェアの劣勢でもいま WebP に対応する意味として伝えたいことです。一部でも共感をしてもらえたら幸いです！
