...
excerpt: 'PageSpeed スコアは変化が曲線的なので、点数帯によって取るべき対策が変わります。20点未満のサイトが改善に着手する前に確かめるべきことを説明します。'
...
その中でも紹介されていますが、スコアの改善に取り組むうえで、スコアの変化が曲線的であることへの理解が必要です。
...
この曲線はPC・モバイル共通です。モバイル向けのスコアは、通信速度とマシン性能を意図的に下げて計測されるだけです。
...
重大なボトルネックでスコアの低迷するケースもあります。過去に実際に目にしたのは、
