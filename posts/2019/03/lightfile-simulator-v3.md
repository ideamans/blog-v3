...
excerpt: '画像をどこまで軽くできるかを無料でレポートする LightFile/WebP シミュレーター v3 を公開しました。削減後の画質をスライダーや差分で確かめられます。'
...
軽量化はたいてい画質の劣化を伴いますが、[LightFile](https://www.ideamans.com/lightfile/)はそれを人間が知覚しにくい範囲で自動的に調整します。
...
レポートの作成には1分ほどかかります。メールアドレスを入力しておくと、レポート完成時にそのアドレスへ通知が送信されます。
