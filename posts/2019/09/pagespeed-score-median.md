...
excerpt: 'PageSpeed スコアは表示速度の世界順位なので、中央値は必ず50点になります。日本のサイトは海外から計測される不利もあり、40点あればまず人並みという話です。'
...
* 日本のサイトなら**40点程度で人並み**
* まず40点以上なら半数のサイトより高速。SEOリスクで神経質にならなくてよいのでは？
...
詳細→<a href="https://qiita.com/miyanaga/items/cc7f9187546e6bac140b">PageSpeed Insightsはどこからどのようにリクエストを送るのか</a>
...
なので対象を日本のサイト(日本国内でホスティングされ、日本のユーザーを対象とするサイト)に絞ると、中央値(人並み)は40点程度と見てよいと思います。
...
もうひとつ、PageSpeedスコアが注目される理由は検索順位への影響です。Googleのスピードアップデートにより表示速度(PageSpeedスコア)が順位に影響すると言われています。
...
その意味でもまずは40点をキープできていれば、SEOリスクは一安心と考えてよいのではないでしょうか。
